...
def gradio_ui():
    with gr.Blocks() as demo:
        gr.Markdown("<h1><center>Document Knowledge Base with Chroma and Ollama</center></h1>")
        ...
        with gr.Tab("View Indexed Documents"):
            docs_output = gr.Textbox(label="Indexed Documents", lines=10, interactive=False)
