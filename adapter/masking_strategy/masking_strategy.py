...
class MaskingStrategy(ABC):
    @abstractmethod
    def mask(self, content: str, extracted_data: Dict[str, List[str]]) -> Tuple[str, Dict]:
        pass
...
if __name__ == "__main__":
    ...
    masked_content, mappings = masking_strategy.mask("Contact me at john.doe@example.com or 123-456-7890.", sensitive_data)
